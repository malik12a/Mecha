...
const Footer = () => {
  return (
    <div className="text-black pt-10 bg-gray-200 px-6 md:px-16 lg:px-30 xl:px-30 h-auto relative">
      <div className="flex flex-wrap justify-between gap-10 md:gap-6">
        ...
        {[
          ...
          },
          {
            ...
            links: [
              <>
                About <span className="font-bold">text|</span>
              </>,
              "Partner Program",
              "Press",
              "Careers",
              "Live Chat Instructor",
              "Legal",
            ],
          },
        ].map((section, idx) => (
          <div key={idx} className="w-full sm:w-[45%] md:w-[30%] lg:w-auto">
            <p className="text-lg text-gray-800 font-bold font-montserrat">
              {section.title}
            </p>
            <ul className="mt-3 flex flex-col gap-2 text-sm font-montserrat">
      ...
      <div className="mt-10 flex flex-col sm:flex-row sm:items-center sm:space-x-4">
        <h3 className="font-montserrat font-bold mb-2 sm:mb-0">
          Start your free trial!
        </h3>
        <button className="bg-red-600 w-fit h-10 rounded-lg text-white px-4">
          Sign up free
        </button>
      </div>

      {/* Logos */}
      <div className=" flex flex-wrap items-center gap-4 lg:ml-220 mt-6">
        {/* Social Icons */}
        {[
          // Instagram
          ...
          <svg key={idx} className="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
            <path d={d} />
          </svg>
        ))}
      </div>
