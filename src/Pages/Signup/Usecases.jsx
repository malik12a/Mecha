...
const Usecases = () => {
  ...
  <div className="relative lg:w-[580px] sm:w-[80%] h-[460px] rounded-2xl ml-20 mt-10">
    <h3 className='font-montserrat ml-10 text-sm mt-2'>Steps 3 of 3</h3>
    <h1 className='font-montserrat font-bold ml-10 text-2xl mt-2'>How can Mecha supercharge your work?</h1>
    <h3 className='font-montserrat ml-10 text-md mt-2'>This will help us drive your success story</h3>
...
<div className="flex flex-col ml-10 mt-4">
  ...
  >
   ...
   <button onClick={() => navigate("/about-company")} className='border-2 border-[#979ffa] mt-3 ml-10 w-30 h-10 rounded-full hover:scale-105'>Back</button>
   <button onClick={() => navigate("/welcome")} className='bg-button text-black mt-3 ml-50 w-30 h-10 rounded-full hover:scale-105'>Next</button>
